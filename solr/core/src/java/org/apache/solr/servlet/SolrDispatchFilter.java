...
import org.apache.solr.core.FSJaegerConfigurator;
...
public class SolrDispatchFilter extends BaseSolrFilter {
  ...
  public void doFilter(ServletRequest _request, ServletResponse _response, FilterChain chain, boolean retry) throws IOException, ServletException {
    ...
    String _req_id = ((HttpServletRequest) _request).getHeader(FSJaegerConfigurator._REQ_ID);
    if(_req_id != null) MDC.put(FSJaegerConfigurator._REQ_ID, _req_id);
    Scope scope = null;
    Span span = null;
    try {
